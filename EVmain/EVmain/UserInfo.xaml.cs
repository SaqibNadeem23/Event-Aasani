    ...
    public partial class UserInfo : ContentPage
    {
        ...
        private void Button_Clicked(object sender, EventArgs e)
        {
            ...
            if (nmC == true && phC == true && psC == true && emC == true)
            {
                ...
                con.Query<Users>("Update Users SET FullName = ?, Email = ?, PhoneNumber = ?, Password = ? Where UserId = ?", e1.Text, e2.Text, e3.Text, e4.Text, SId);
                con.Close();

                DisplayAlert("Successfull", "Updated Successfully", "ok");
                Navigation.PushAsync(new MasterPage(SId, e1.Text, e2.Text, e3.Text, e4.Text));
            }
        }
